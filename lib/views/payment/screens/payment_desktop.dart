...
class PaymentDesktop extends ConsumerWidget {
  const PaymentDesktop({super.key, required this.enrolment});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  enrolment.paymentMethod=="insta-wallet"?PaymentInfoEgypt(enrolment: enrolment,isMobile: false,):PaymentInfoOther(enrolment: enrolment,isMobile: false,),
                  SizedBox(height: 30,),
                  UploadPayment(enrolment: enrolment,isMobile: false,),
                ]
              ),
            ),
          ),
